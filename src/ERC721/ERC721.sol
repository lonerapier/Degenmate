...
abstract contract ERC721 is IERC165, IERC721, IERC721Metadata {
    ...
    {
        return
            spender == _owners[tokenId] ||
            spender == _approvals[tokenId] ||
            _isApprovedForAll[_owners[tokenId]][spender];
    }
    ...
    function _transfer(
        ...
        address _to,
        uint256 _tokenId
    ) internal virtual _validAddress(_to) {
    ...
    function transferFrom(
        ...
        address _to,
        uint256 _tokenId
    ) public virtual override _exists(_tokenId) {
        require(_isOwnerOrApproved(msg.sender, _tokenId), "access denied");
